...
/** @author @EWCunha
 *  @title DollarCostAverage smart contract invariant (stateful) test - continues on revert
 */
...
import {DollarCostAverageContinueOnRevertHandler} from "./DollarCostAverageContinueOnRevertHandler.t.sol";

contract DollarCostAverageContinueOnRevertInvariant is StdInvariant, Test {
    /* solhint-disable */
    Deploy deployer;
    DollarCostAverage dca;
    HelperConfig config;
    AutomationLayer automation;
    DollarCostAverageContinueOnRevertHandler handler;
    ...
    function setUp() public {
        ...
        handler = new DollarCostAverageContinueOnRevertHandler(
            dca,
            address(weth),
            address(uni)
        );
