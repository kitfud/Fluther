...
contract DollarCostAverage {
    ...
    function createRecurringBuy(
        ...
        accountNumberToIndex[accountNumber] = recurringBuys.length - 1;
    ...
    function transferFunds(uint256 accountNumber) public hasSufficientTokens {
    ...
    function checkTrigger(uint256 accountNumber) external view returns (bool) {
        ...
        RecurringBuys storage buy = recurringBuys[index];
        return buy.paymentDue < block.timestamp && buy.canceled == false;
    }
